...
namespace dks3Api.Models
{
    ...
    public class Weapon
    {
        ...
        [Display(Name = "Weapon Art")]
        public WeaponArt WeaponArt { get; set; }
        [Display(Name = "Attack Power")]
        public AttackPower AttackPower { get; set; }
        [Display(Name = "Damage Absorption")]
        public DamageAbsorption DamageAbsorption { get; set; }
        [Display(Name = "Damage Scaling")]
        public DamageScaling DamageScaling { get; set; }
        [Display(Name = "Additional Effects")]
